                    ...
                    <div class="col-sm-8">
                        <div class="card-body">
                            ...
                            <p class="mb-4 text-white-50">
                                Ini adalah dashboard panel IDUKA (Industri dan Dunia Kerja). Anda dapat mengelola data profil, memantau usulan peserta PKL, dan melakukan evaluasi kehadiran.
                            </p>
                            <a href="{{ route('iduka.pribadi') }}" class="btn btn-light text-primary border-0 shadow-sm fw-semibold">
                                <i class="fas fa-user-edit me-2"></i> Lengkapi Profil IDUKA
                            </a>
                        </div>
                    </div>
        ...
        <div class="col-lg-4 col-md-6 mb-4">
            <div class="card shadow-sm border-0 h-100 card-hover">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div>
                        <h6 class="mb-0 text-muted">Total Kuota PKL</h6>
        ...
        <div class="col-12">
            <div class="card shadow-sm border-0 card-hover">
                ...
                <div class="card-body pt-4">
                    <p class="text-secondary">Mohon pastikan untuk melengkapi profil IDUKA Anda agar siswa dapat menemukan dan mengajukan usulan PKL ke perusahaan Anda. Gunakan menu navigasi di sebelah kiri untuk melihat daftar pengajuan dan melakukan konfirmasi administrasi.</p>
                </div>
            </div>
        </div>
    </div>
