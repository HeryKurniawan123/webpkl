...
<div class="row g-3">
    ...
    <div class="col-md-3 col-6">
        <form method="POST" action="{{ route('absensi.masuk') }}" id="formMasuk">
            ...
            <button type="submit" class="btn btn-success w-100 btn-absensi"
                id="btnMasuk"
    ...
    <div class="col-md-3 col-6">
        <form method="POST" action="{{ route('absensi.pulang.siswa') }}" id="formPulang">
            ...
            <button type="submit" class="btn btn-warning w-100 btn-absensi"
                id="btnPulang"
    ...
    <div class="col-md-3 col-6">
        <button type="button" class="btn btn-info w-100 btn-absensi" id="btnIzin"
            ...
            {{ $hasPendingIzin || $hasApprovedIzin ? 'disabled' : '' }}
            {{ $hasPendingDinas || $hasApprovedDinas ? 'disabled' : '' }}
            {{ $hasPendingMasuk ? 'disabled' : '' }}
            {{ $hasPendingPulang ? 'disabled' : '' }}>
            <div class="btn-content">
   ...
   <style>
    ...
    <script>
        ...
        function updateLocationInfo(position) {
            ...
            // Update UI
            distanceValue.textContent = Math.round(distance) + " meter dari " + lokasiName + " (akurasi: ±" + Math.round(
                accuracy) + "m)";
