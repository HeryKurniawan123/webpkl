                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                <li>
                                                    <a href="#" class="dropdown-item">
                                                        <i class="bi bi-filetype-pdf text-danger"></i> <span
                                                            class="text-danger">Export PDF</span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="{{ route('iduka.edit', $iduka->id) }}" class="dropdown-item">
                                                        <i class="bi bi-pencil-square text-warning"></i> <span
                                                            class="text-warning">Edit</span>
                                                    </a>
                                                </li>
                                            </ul>
                                        </div> --}}
