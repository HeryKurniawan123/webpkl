    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content" style="border-radius: 15px;">
            <div class="modal-header"
                style="background: linear-gradient(135deg, #28a745 0%, #20c997 100%); border-top-left-radius: 15px; border-top-right-radius: 15px;">
            ...
            <div class="modal-body p-4">
                <div class="row">
                    <div class="col-md-4 text-center mb-4">
                        <img src="https://ui-avatars.com/api/?name=Ahmad+Fauzi&background=28a745&color=fff&size=120&rounded=true"
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-success"
                    style="border-radius: 10px; background: linear-gradient(45deg, #28a745, #20c997);">
                    ...
                    <div class="card h-100 border-0 shadow-sm" style="border-radius: 15px; transition: all 0.3s ease;"
                        ...
                        <div class="card-body p-4">
                            <div class="text-center mb-3">
                                <div class="position-relative d-inline-block">
                                    <img src="https://ui-avatars.com/api/?name=Drs+Ahmad+Wijaya&background=667eea&color=fff&size=80&rounded=true"
                        ...
                        <div class="d-flex flex-wrap gap-1">
                            ...
                            <div class="d-grid gap-2">
                                ...
                                <button class="btn btn-outline-success" style="border-radius: 10px;"
                                    data-bs-toggle="modal" data-bs-target="#detailModal">
                                    <i class="fas fa-plus me-2"></i>Tambah siswa
                                </button>
                                <button class="btn btn-outline-gray" style="border-radius: 10px;"
                                    data-bs-toggle="modal" data-bs-target="#detailModal">
                                    <i class="fas fa-eye me-2"></i>Lihat Siswa
                                </button>
                            </div>
                        </div>
                    </div>
                        ...
                        <ul class="pagination justify-content-center">
                            ...
                            <li class="page-item active">
                                <a class="page-link" href="#"
                                    style="border-radius: 10px; background: linear-gradient(45deg, #667eea, #764ba2);">1</a>
                            </li>
                            <li class="page-item">
                    ...
                    <div class="modal-body p-4">
                        <div class="row">
                            ...
                            <div class="col-md-4 d-flex flex-column align-items-center justify-content-center text-center">
                                <img src="https://ui-avatars.com/api/?name=Drs+Ahmad+Wijaya&background=667eea&color=fff&size=120&rounded=true"
                                    alt="Profile" class="rounded-circle mb-3" style="width: 120px; height: 120px;">
