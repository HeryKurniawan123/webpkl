...
<p style="margin-bottom:20px; font-size: 12px; text-align: justify;">
    Untuk melaksanakan Praktik Kerja Lapangan dalam rangka Pendidikan Sistem Ganda (PSG) pada IDUKA saudara selama 5 (lima) bulan, dengan waktu pelaksanaan dari tanggal 08 Juli s.d 15 November 2024. Pada akhir kegiatan Praktik Kerja Lapangan, siswa diwajibkan menyerahkan Jurnal Kegiatan PKL yang telah diketahui dan disetujui oleh pihak IDUKA, sebagai salah satu acuan dalam menilai kegiatan PKL siswa.
    ...
    <table width="100%" style="font-size: 14px;">
        <tr>
            <td style="vertical-align: top; width: 60%;">
                <p><strong>Nomor</strong> : /PK.06/SMKN1KWL</p>
                <p><strong>Lampiran</strong> : -</p>
                <p><strong>Perihal</strong> : Pengantar Pelaksanaan Praktik<br>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Kerja Lapangan (PKL)</p>
            </td>
            <td style="vertical-align: top; width: 40%; text-align: right;">
                <p>Kepada :</p>
                <p>Yth. Pimpinan Inovindo Digital Media<br>
                Di<br>
                Bandung</p>
            </td>
        </tr>
