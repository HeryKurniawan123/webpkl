                        ...
                        <form action="{{ route('hubin.iduka.daftar') }}" method="GET">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control border-start-0 ps-0"
                                    placeholder="Cari nama, NIP, atau email..." name="search" value="{{ $search ?? '' }}">
                        ...
                        <tbody>
                            @forelse ($data as $iduka)
                                <tr>
                                    ...
                                    <td>
                                        <span class="fw-medium">{{ $iduka->email }}</span>
                                    </td>
                                    <td>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control" id="editLatitude" name="latitude" step="any" placeholder="-6.2088">
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                <span class="input-group-text"><i class="bi bi-geo-alt"></i></span>
                                <input type="number" class="form-control" id="editLongitude" name="longitude" step="any" placeholder="106.8456">
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control" id="editRadius" name="radius" placeholder="100">
                            </div>
